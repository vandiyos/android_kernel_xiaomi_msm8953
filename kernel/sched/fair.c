 ...
 * ANDROID CHANGES
 * 
 * Disable auto-scaling of scheduler with hotplug. The tunables
 ...
 * (default: 0.30 msec * (1 + ilog(ncpus)), units: nanoseconds))
 */
